...
public class GamePanel extends JPanel implements ActionListener, KeyListener, MouseMotionListener, MouseListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_LEFT) {
			...
			/*
			 * currentState++; if(currentState == END_STATE) { currentState = MENU_STATE; }
			 */
	...
	public void mouseMoved(MouseEvent e) {
		// TODO Auto-generated method stub
		if (e.getX() < Breakout.width - paddle.width) {
			paddle.x = e.getX();
		}
	}
	...
	public void mouseClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		if (currentState == MENU_STATE || currentState == GAME_TITLE1 || currentState == GAME_TITLE2
				|| currentState == GAME_TITLE3) {
			currentState++;
			manager = new ObjectManager(paddle, level);
			paddle.width = 100;
		} else if (currentState == GAME_OVER) {
